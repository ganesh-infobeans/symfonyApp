...
class QuestionaryController extends Controller
{
    public function indexAction(Request $request)
    {
        ...
        ->add('q4', 'choice', array('choices' => array('1'=>'Bundle','2'=> 'Router','3'=>'COntroller ','4'=>'Model'),'label' => ' Which of the following in Symfony is a directory that houses everything related to a specific feature, including PHP classes, configuration, and
